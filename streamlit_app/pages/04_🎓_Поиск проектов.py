...
def run():
    ...
    st.write('''
            ...
            :mag: __Поиск по проектам__ позволяет составить выборку проектов, в которых фигурирует введенный текст.  
            :art: __Параметры фильтрации__ позволяют составить выборку проектов, которая удовлетворяет заданным параметрам.\n
